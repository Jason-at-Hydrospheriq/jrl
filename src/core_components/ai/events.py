...
class InputEvent(BaseEvent):
    ...
    def __init__(self, handler: Handler | None = None, state: GameState | None = None, event: tcod.event.Event | None = None) -> None:
        super().__init__(handler, state)
...
class EntityEvent(BaseEvent):
    ...
    def __init__(self, handler: Handler | None = None, state: GameState | None = None, entity: BaseEntity | None = None) -> None:
        super().__init__(handler, state)
...
class CharactorEvent(BaseEvent):
    ...
    def __init__(self, handler: Handler | None = None, state: GameState | None = None, entity: Charactor | None = None, target: Charactor | None = None) -> None:
        super().__init__(handler, state)
...
class AIEvent(BaseEvent):
    ...
    def __init__(self, handler: Handler | None = None, state: GameState | None = None, entity: AICharactor | None = None, target: Charactor | None = None) -> None:
        super().__init__(handler, state)
